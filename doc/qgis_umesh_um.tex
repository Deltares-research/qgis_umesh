...
Examples are given for a scalar field (Depth averaged velocity magnitude) and the corresponding vector field.
%------------------------------------------------------------------------------
\subsection{Example scalar field}
\begin{figure}[H]
	\centering    
	\includegraphics[width=0.95\textwidth]{pictures/oosterschelde_scalar.png}
...
\begin{figure}[H]
	\centering    
	\includegraphics[width=0.95\textwidth]{pictures/oosterschelde_vector.png}
