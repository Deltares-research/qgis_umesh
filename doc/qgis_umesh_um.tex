...
\memoTelephone{---}
\memoEmail{---}
\memoSubject{Manual to plot result files of \dflowfm in QGIS 4.0 (map- and history-files)}
\memoCopy{}
%
\deltarestitle
...
When selecting this option, you can choose \netcdf files which meet the UGRID standard.
...
When selecting this option, you can choose \netcdf files that meet the Climate and Forecast (CF) history file standard.
