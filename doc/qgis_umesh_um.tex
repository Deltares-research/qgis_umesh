...
\begin{longtable}{p{35mm-12pt} p{\textwidth-35mm-12pt}} 
	...
	\textbf{Transparency} & \\
	Transparency & Specify the transparency of the iso patches for the scalars by a integer number [\%] or by the slider, the range of the permitted values is: 0 - 100 [\%]. \\
