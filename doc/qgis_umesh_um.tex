...
\memoSubject{Manual to plot result files of \dflowfm in QGIS 3.26 (map- and history-files)}
\memoCopy{}
%
\deltarestitle

%
\execute{git log >introduction.tex}
%
{{\footnotesize
{\textbf{Version control information}}\newline
\begin{tabular}{@{}p{12,5mm}@{}p{0mm}p{\textwidth-27mm-24pt}}
    \textbf{Location} & \textbf{:} & \gitBranch \\
    \textbf{Revision} & \textbf{:} & \gitHash
\end{tabular}
}}
