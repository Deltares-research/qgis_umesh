...
copy "c:\OSGeo4W\apps\qgis\plugins\qgis_umesh.dll"      n:\Deltabox\Bulletin\mooiman\programs\QGIS_3.24.01_qgis_umesh\*.*
copy .\doc\qgis_umesh_um.pdf                            n:\Deltabox\Bulletin\mooiman\programs\QGIS_3.24.01_qgis_umesh\doc\*.*
copy .\doc\qgis_umesh_installation.pdf                  n:\Deltabox\Bulletin\mooiman\programs\QGIS_3.24.01_qgis_umesh\doc\*.*
copy .\icons\*.*                                        n:\Deltabox\Bulletin\mooiman\programs\QGIS_3.24.01_qgis_umesh\icons\*.*
rem pause
